...
EOF
    ...
    # Hook install check lives in SKILL.md Step 0 — the skill text is
    # authoritative because it runs even when anchor.sh isn't yet wired
    # (chicken-and-egg). Nothing to do here.
fi
